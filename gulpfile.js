...
gulp.task('lib', function () {
  return gulp.src(dirs.lib)
    .pipe(gulp.dest(dirs.public + '/lib'));
});

gulp.task('lib:watch', function () {
  return gulp.watch(dirs.lib, ['lib']);
});
...
// Running Tasks
//////////////////////////////
gulp.task('build', ['uglify', 'sass', 'images', 'lib']);

gulp.task('test', ['build']);

gulp.task('watch', ['eslint:watch', 'uglify:watch', 'sass:watch', 'images:watch', 'lib:watch']);
